...
export function ProjectCard({ project, onSwipe, onCardRemove, isTopCard }: ProjectCardProps) {
    ...
    >
      <div className="relative w-full h-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-200">
        ...
        <div className="relative h-48 bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
          ...
          {/* Difficulty Badge */}
          <div className={`absolute top-4 left-4 ${difficultyColors[project.difficulty as keyof typeof difficultyColors]} text-white px-3 py-1 rounded-full text-sm font-semibold`}>
            {project.difficulty}
          </div>
        </div>
