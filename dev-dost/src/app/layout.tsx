...
export const metadata: Metadata = {
  ...
  description: "Find partners for building projects. Connect with developers across cities and build amazing projects together.",
  keywords: ["developers", "projects", "collaboration", "coding", "partnership"],
