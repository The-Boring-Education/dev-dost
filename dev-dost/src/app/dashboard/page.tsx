    ...
    try {
      ...
      if (response.ok) {
        ...
        if (direction === "right") {
          ...
          if (data.match) {
            toast.success(`🎉 It's a match! You and ${data.match.otherUserName} both want to build this project!`, {
              duration: 5000,
            });
          }
        }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Loading amazing projects for you...</p>
        </div>
      </div>
    );
  }
        ...
        >
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/80 text-sm">Projects Seen</p>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/80 text-sm">Interested In</p>
                <p className="text-white text-2xl font-bold">{stats.interestedCount}</p>
              </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-white text-2xl font-bold">{stats.matchesCount}</p>
              </div>
          ...
          {hasNoMoreProjects ? (
            ...
            >
              ...
              <p className="text-white/80 mb-6">
                Great job exploring! Check back later for new projects or create your own.
              </p>
