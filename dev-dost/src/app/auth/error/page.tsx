...
const errorMessages: Record<string, { title: string; description: string; solution: string }> = {
  OAuthAccountNotLinked: {
    ...
    description: "This email is already associated with another account method.",
    solution: "Please try signing in with the method you used previously, or contact support if you need help.",
  },
  OAuthCallbackError: {
    title: "Authentication Failed",
    description: "There was an error during the sign-in process.",
    solution: "Please try signing in again. If the problem persists, check your internet connection.",
  },
  AccessDenied: {
    title: "Access Denied",
