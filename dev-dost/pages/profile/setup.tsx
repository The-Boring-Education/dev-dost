...
export default function ProfileSetupPage() {
  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      case 1:
        return formData.bio.trim().length >= 10 && formData.location.trim().length > 0;
      case 2:
  ...
  const interestOptions = [
    ...
    "Blockchain", "Game Development", "AI/ChatGPT", "DevOps", "UI/UX Design",
    "Backend APIs", "Frontend Frameworks", "Cloud Computing", "Open Source",
    "Startup Ideas", "E-commerce", "Fintech", "Healthtech", "Edtech"
  ];
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mb-4">
                      {techStackOptions.slice(0, 12).map((skill) => (
                        <button
                          key={skill}
                    ...
                    {formData.skills.length > 0 && (
                      <div>
                        <p className="text-gray-300 text-sm mb-2">Selected Skills:</p>
              ...
              {currentStep === 3 && (
                ...
                >
                  <div>
                    <label className="block text-white font-medium mb-2">
                      Project Interests * (What type of projects excite you?)
                    </label>
                    <div className="mb-4">
                      <div className="flex space-x-2">
                        <input
                    ...
                    {formData.interests.length > 0 && (
                      <div>
                        <p className="text-gray-300 text-sm mb-2">Selected Interests:</p>
                        <div className="flex flex-wrap gap-2">
                ...
                >
                  <div className="mb-6">
                    <h3 className="text-white text-lg font-semibold mb-2">
                      How can your project partners contact you?
                    </h3>
                    <p className="text-gray-300 text-sm">
                      When you match with someone, they'll see your preferred contact methods.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={formData.contactPreferences.telegram}
                  ...
                  <div className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-4">
                    <h4 className="text-blue-200 font-medium mb-2">Privacy Note</h4>
                    <p className="text-blue-100 text-sm">
                      Your contact information will only be shared when you successfully match with another developer on a project. 
