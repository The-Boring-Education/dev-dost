          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              >
                ...
                >
                  Swipe right on projects, connect with developers across cities, and build amazing things together. 
                  <strong className="text-white"> It&apos;s Tinder for Builders! 🚀</strong>
                </motion.p>
              </motion.div>
              ...
              {[
                {
                  ...
                  description: "Swipe through exciting project ideas or create your own. From web apps to AI projects.",
                },
                {
                  icon: <Heart className="w-8 h-8" />,
                  title: "Find Your Match",
                  description: "When two developers both swipe right on the same project, magic happens! You get matched.",
                },
                {
                  icon: <Users className="w-8 h-8" />,
                  title: "Build Together",
                  description: "Connect via WhatsApp, Telegram, or email. Start building your next amazing project together.",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Join hundreds of developers who are already building amazing projects together. 
