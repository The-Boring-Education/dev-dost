...
export default function MatchesPage() {
    ...
    const filteredMatches = matches.filter(match => {
        ...
        const matchesSearch = !searchTerm || 
            ...
            match.otherUser.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
            match.projectId.techStack.some(tech => tech.toLowerCase().includes(searchTerm.toLowerCase()))
                        ...
                        <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 border border-white/20">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-gray-300 text-sm">Active Matches</div>
                                </div>
                            </div>
                        </div>
                        ...
                        {sortedMatches.map((match, index) => (
                            <motion.div
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center space-x-3">
                                        <img
                                            src={match.otherUser.image || "/default-avatar.png"}
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-300 text-sm capitalize">
                                                {match.otherUser.experience} Developer
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="mb-4 p-4 bg-white/5 rounded-lg">
                                    ...
                                    <div className="flex flex-wrap gap-1">
                                        {match.projectId.techStack.slice(0, 4).map((tech) => (
                                            <span key={tech} className="bg-blue-500/20 text-blue-200 px-2 py-1 rounded text-xs">
                                                {tech}
                                            </span>
                                        ))}
                                        {match.projectId.techStack.length > 4 && (
                                            <span className="bg-gray-500/20 text-gray-300 px-2 py-1 rounded text-xs">
                                                +{match.projectId.techStack.length - 4} more
                                            </span>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-1 mb-3">
                                        {match.otherUser.skills.slice(0, 5).map((skill) => (
                                            <span key={skill} className="bg-green-500/20 text-green-200 px-2 py-1 rounded text-xs">
                                                {skill}
                                            </span>
                                        ))}
                                        {match.otherUser.skills.length > 5 && (
                                            <span className="bg-gray-500/20 text-gray-300 px-2 py-1 rounded text-xs">
                                                +{match.otherUser.skills.length - 5} more
                                            </span>
                                        )}
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center space-x-2 text-sm">
                                            ...
                                            <a 
                                                ...
                                                {match.otherUser.contactPreferences.email}
                                            </a>
                                        </div>
                                        
                                        {match.otherUser.contactPreferences.whatsapp && (
                                            <div className="flex items-center space-x-2 text-sm">
                                                ...
                                                <a 
                                                    ...
                                                    <span>{match.otherUser.contactPreferences.whatsapp}</span>
                                                    <ExternalLink className="w-3 h-3" />
                                                </a>
                                            </div>
                                        )}

                                        {match.otherUser.contactPreferences.telegram && (
                                            <div className="flex items-center space-x-2 text-sm">
                                                ...
                                                <a 
                                                    ...
                                                    <span>{match.otherUser.contactPreferences.telegram}</span>
                                                    <ExternalLink className="w-3 h-3" />
                                                </a>
                                            </div>
                                        )}
                                        ...
                                        {match.otherUser.githubProfile && (
                                            <div className="flex items-center space-x-2 text-sm">
                                                ...
                                                <a 
                                                    href={match.otherUser.githubProfile}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                        ...
                                        {match.otherUser.portfolioUrl && (
                                            <div className="flex items-center space-x-2 text-sm">
                                                ...
                                                <a 
                                                    href={match.otherUser.portfolioUrl}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                ...
                                <div className="flex flex-wrap gap-2 mt-4">
                                    {!match.conversationStarted && match.status === "pending" && (
                                        <button
                                            onClick={() => markConversationStarted(match._id)}
                                    ...
                                    {match.status === "pending" && (
                                        <button
                                            onClick={() => updateMatchStatus(match._id, "active")}
