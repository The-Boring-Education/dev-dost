        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.match) {
                    ...
                    toast.success(
                        interested ? "Swiped right! 💫" : "Swiped left! 👈"
                    )
                }
                ...
                <div className='text-center mb-8'>
                    <motion.div
                        ...
                        <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
                            Ready to find your next dev partner? Swipe through
                            exciting projects and discover your perfect match!
                        </p>
                    </motion.div>
                            ...
                            <motion.div
                                ...
                                <div className='bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20'>
                                    ...
                                    <p className='text-gray-300 mb-6 max-w-md mx-auto'>
                                        You've seen all available projects.
                                        Check back later for new exciting
                                        opportunities, or refresh to see if we
                                        have more projects available.
                                    </p>
                            ...
                            <div className='space-y-4'>
                                <div className='flex items-start space-x-3'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'>
                                            Only swipe right on projects you're
                                ...
                                <div className='flex items-start space-x-3'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'>
                                            When you match, reach out quickly to
                            ...
                            <div className='space-y-4'>
                                ...
                                <div className='flex items-start space-x-3'>
                                    ...
                                    <div>
                                        ...
                                        <p className='text-gray-300 text-sm'>
                                            Begin with a smaller feature to test
