...
const ERROR_MESSAGES = {
    OAuthAccountNotLinked: {
        ...
        description:
            "There was a problem linking your Google account. This usually happens when an account with the same email already exists.",
        solutions: [
                ...
                <motion.div
                    ...
                    <motion.div
                        ...
                        <p className='text-gray-400 text-sm mb-4'>
                            Still having trouble? Here are some additional
                            steps:
                        </p>
                        <div className='text-gray-300 text-sm space-y-2'>
                            ...
                            <p>
                                • Make sure your system date and time are
                                correct
                            </p>
                        </div>
                    </motion.div>
