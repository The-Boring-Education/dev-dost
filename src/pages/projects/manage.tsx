...
export default function ManageProjectsPage() {
    ...
    const [sortBy, setSortBy] = useState<"newest" | "oldest" | "popular" | "matches">("newest")
                        ...
                        {sortedProjects.map((project, index) => (
                            <motion.div
                                ...
                                <div className="grid grid-cols-3 gap-4 text-center text-sm">
                                    <div>
                                        <div className="text-white font-semibold">{project.viewCount}</div>
                                        <div className="text-gray-400">Views</div>
                                    </div>
                                    <div>
                                        <div className="text-white font-semibold">{project.interestCount}</div>
                                        <div className="text-gray-400">Interests</div>
                                    </div>
                                    <div>
                                        <div className="text-white font-semibold">{project.matchCount}</div>
